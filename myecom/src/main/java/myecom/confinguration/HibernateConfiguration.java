...
Driver class will available in H2 console
	  ...
	  */
		private final static String JDBC_URL = "jdbc:h2:tcp://localhost/~/myecom";
		private final static String JDBC_DRIVER_CLASS = "org.h2.Driver";		
		private final static String JDBC_USERNAME = "arun";
